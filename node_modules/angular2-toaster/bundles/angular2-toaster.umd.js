(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('rxjs/Observable'), require('rxjs/add/operator/share'), require('rxjs/Subject'), require('@angular/animations'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', 'rxjs/Observable', 'rxjs/add/operator/share', 'rxjs/Subject', '@angular/animations', '@angular/common'], factory) :
	(factory((global.angular2toaster = {}),global.ng.core,global.platformBrowser,global.Rx,global.Rx,global.Rx,global.animations,global.ng.common));
}(this, (function (exports,core,platformBrowser,Observable,share,Subject,animations,common) { 'use strict';
...
var ToastComponent = /** @class */ (function () {
    ...
    ToastComponent.propDecorators = {
        ...
        "titleClass": [{ type: core.Input },],
        "messageClass": [{ type: core.Input },],
        "componentBody": [{ type: core.ViewChild, args: ['componentBody', { read: core.ViewContainerRef },] },],
...
var ToasterService = /** @class */ (function () {
    ...
    function ToasterService() {
        var _this = this;
        this.addToast = new Observable.Observable(function (observer) { return _this._addToast = observer; }).share();
        this.clearToasts = new Observable.Observable(function (observer) { return _this._clearToasts = observer; }).share();
        this._removeToastSubject = new Subject.Subject();
