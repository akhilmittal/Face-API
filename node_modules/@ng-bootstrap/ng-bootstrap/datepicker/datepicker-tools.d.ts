...
export declare function buildMonths(calendar: NgbCalendar, date: NgbDate, state: DatepickerViewModel, force: boolean): MonthViewModel[];
export declare function buildMonth(calendar: NgbCalendar, date: NgbDate, state: DatepickerViewModel): MonthViewModel;
